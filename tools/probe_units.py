...
async def main(address: str) -> None:
    async with BleakClient(address) as client:
        ...
        print("Known community mappings (conflicting):")
        print("  h4/lywsd02 dict: 0xFF=C, 0x01=F")
        print("  h4/lywsd02 comment: 0x00=F, 0x01=C")
        print()

        try:
            opposite = b"\x01" if original[:1] != b"\x01" else b"\xff"
